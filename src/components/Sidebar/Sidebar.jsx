    ...
    render() {
        ...
        var user = (
            <div className={userWrapperClass}>
                <div className={photo}>
                    <img src={this.state.userinfo.avatar != null?this.state.userinfo.avatar:avatar} className={classes.avatarImg} alt="..."/>
                </div>
                <List className={classes.list}>
                    <ListItem className={classes.item + " " + classes.userItem}>
                        <NavLink
                            ...
                            <ListItemText
                                primary={this.state.userinfo.name + "（" + this.state.userinfo.rule + "）"}
                                secondary={
                                    <b
                                        className={
        ...
        var brand = (
            <div className={logoClasses}>
                <a href="http://coolpy.net" className={logoMini}>
                    <img src={logo} alt="logo" className={classes.img}/>
                </a>
                <a href="http://coolpy.net" className={logoNormal}>
                    {logoText}
                </a>
            </div>
        );
